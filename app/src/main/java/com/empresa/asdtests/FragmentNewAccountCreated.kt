 ...
 * Use the [FragmentNewAccountCreated.newInstance] factory method to
...
class FragmentNewAccountCreated : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentNewAccountCreated.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentNewAccountCreated().apply {
